...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_AND_TIMES = 5,                  /* AND_TIMES  */
  YYSYMBOL_OR_TIMES = 6,                   /* OR_TIMES  */
  YYSYMBOL_7_ = 7,                         /* '+'  */
  YYSYMBOL_8_ = 8,                         /* '-'  */
  YYSYMBOL_9_ = 9,                         /* '*'  */
  YYSYMBOL_10_ = 10,                       /* '/'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEGER", "INC_OP",
  "AND_TIMES", "OR_TIMES", "'+'", "'-'", "'*'", "'/'", "UMINUS", "'\\n'",
...
{
      -8,    14,    -8,    -8,    12,    12,    -7,    35,    -2,    24,
      -8,    12,    12,    12,    12,    12,    12,    12,    -8,    -2,
      -2,    -2,    42,    42,    -2,    -2
};
...
{
       8,     9,    11,    12,    13,    10,     0,    19,    20,    21,
      22,    23,    24,    25,     2,     3,     0,     3,     0,     0,
       4,     0,     4,     0,     0,     5,     0,     5,    11,    12,
      13,    14,    15,    16,    17,     0,     0,     0,    18,    11,
      12,    13,    14,    15,    16,    17,    11,    12,    13,     0,
       0,    16,    17
};

static const yytype_int8 yycheck[] =
{
       4,     5,     4,     5,     6,    12,    -1,    11,    12,    13,
      14,    15,    16,    17,     0,     3,    -1,     3,    -1,    -1,
       8,    -1,     8,    -1,    -1,    13,    -1,    13,     4,     5,
       6,     7,     8,     9,    10,    -1,    -1,    -1,    14,     4,
...
{
       0,    16,     0,     3,     8,    13,    17,    18,    18,    18,
      12,     4,     5,     6,     7,     8,     9,    10,    14,    18,
      18,    18,    18,    18,    18,    18
};
...
#line 1126 "calc.tab.c"
  ...
  case 12: /* expr: expr INC_OP expr  */
#line 29 "calc.y"
                         {yyval = yyvsp[-2] + (yyvsp[0] + 1);}
#line 1132 "calc.tab.c"
    break;

  case 13: /* expr: expr AND_TIMES expr  */
#line 30 "calc.y"
                            {yyval = (yyvsp[-2] & yyvsp[0]) * yyvsp[0];}
#line 1138 "calc.tab.c"
    break;

  case 14: /* expr: expr OR_TIMES expr  */
#line 31 "calc.y"
                           {yyval = (yyvsp[-2] | yyvsp[0]) * yyvsp[0];}
